...
const ThemeEditor: React.FC<ThemeEditorProps> = ({ profileData, onUpdate }) => {
  const presetThemes = [
    ...
    { name: 'Midnight Blue', primary: '#1E40AF', secondary: '#3B82F6', accent: '#06B6D4' }
  ];
          ...
          <div className="space-y-3">
            <div className="flex items-center space-x-3">
              ...
              <input
                ...
                value={profileData.theme.primary}
                onChange={(e) => handleCustomColorChange('primary', e.target.value)}
                className="flex-1 px-3 py-1 text-sm border border-gray-200 rounded focus:ring-2 focus:ring-violet-500 focus:border-transparent"
              />
            </div>
