    ...
    <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          className="flex items-center space-x-2 px-4 py-2 bg-violet-600 text-white rounded-lg hover:bg-violet-700 transition-all"
        >
      ...
      <div className="space-y-6">
                  ...
                  <button
                    ...
                    className={`p-2 rounded-lg transition-all ${
                      widget.layout === 'grid'
                        ...
                        : 'bg-gray-100 text-gray-400 hover:text-violet-600'
                    }`}
                    title="Grid layout"
                  >
        ...
        {photoWidgets.length === 0 && !isAddingWidget && (
          <div className="text-center py-12 text-gray-500">
            ...
            <button
              onClick={() => setIsAddingWidget(true)}
              className="inline-flex items-center space-x-2 px-4 py-2 bg-violet-600 text-white rounded-lg hover:bg-violet-700 transition-all"
            >
              <Plus className="w-4 h-4" />
