...
import { Edit3, Eye, QrCode, User, LogOut, Settings } from 'lucide-react';
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center space-x-2 bg-gradient-to-br from-violet-500 to-pink-500 text-white px-3 py-2 rounded-xl hover:shadow-lg transition-all duration-200"
              >
