...
import { MapPin, Mail, Phone, Star, Globe, Linkedin, Twitter, Github, Instagram, Facebook, Youtube, MessageCircle, UserPlus, ChevronLeft, ChevronRight } from 'lucide-react';
          ...
          <div className="bg-white rounded-2xl p-6 w-full max-w-sm">
            ...
            <div className="flex space-x-3">
              <button
                ...
                className="flex-1 py-2 px-4 bg-blue-600 text-white rounded-lg font-medium disabled:opacity-50 disabled:cursor-not-allowed hover:bg-blue-700 transition-colors"
              >
                Send Email
              </button>
              <button
